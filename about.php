    ...
    <div class="row">
      ...
      <div class="col-xl-6">
        <div class="party-balloon-img">
          <img alt="party-balloon" class="p-balloon" src="https://placehold.co/360x360">
          <img alt="party-balloon" src="https://placehold.co/546x546">
...
<section class="gap no-top">
  <div class="container">
    <div class="heading">
      ...
      <h2>Meet Decoration Team</h2>
      <p>Love With Our Wide Selection Of Foil Balloons</p>
    </div>
    <div class="row">
      <div class="col-xl-3 col-lg-4 col-md-6">
        <div class="team-text">
          <img alt="team" src="https://placehold.co/294x294">
...
<section class="gap" style="background-color: #f7f7f7 ;">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <div class="heading two">
          <h2>Help Center - Faq’s</h2>
          <p>Love With Our Wide Selection Of Foil Balloons</p>
        </div>
        <div class="accordion">
          <div class="accordion-item">
            <a href="#" class="heading">
              <div class="icon"></div>
              <div class="title">Using Balloon Disks And Clips To Quickly Tie Balloons?</div>
            </a>

            <div class="content">
              <p>Yes available online and store location. At this time, our products are only available for one store
                and purchase online.
              </p>
            </div>
          </div>
          ...
          <div class="accordion-item active">
            <a href="#" class="heading">
              <div class="icon"></div>
              <div class="title">Can i Pick up my order in a Store, Instead of Delivery?</div>
            </a>
              ...
              <h6>
                <i>
                  <svg version="1.1" xml:space="preserve" width="682.66669" height="682.66669"
                    ...
                    <g id="g2325" transform="matrix(1.3333333,0,0,-1.3333333,0,682.66667)">
                      <g id="g2327">
                        <g id="g2329" clip-path="url(#clipPath2333)">
                          <g id="g2335" transform="translate(256,92)">
                            <path
                              ...
                              style="fill:none;stroke:#672b83;stroke-width:40;stroke-linecap:square;stroke-linejoin:miter;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"
                              id="path2337" />
                          </g>
                          <g id="g2339" transform="translate(316,372)">
                            <path d="m 0,0 -80,-80 -40,40"
                              style="fill:none;stroke:#672b83;stroke-width:40;stroke-linecap:square;stroke-linejoin:miter;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"
                              id="path2341" />
                          </g>
                          <g id="g2343" transform="translate(176,20)">
                            <path d="M 0,0 H 160"
                              style="fill:none;stroke:#672b83;stroke-width:40;stroke-linecap:square;stroke-linejoin:miter;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"
                              id="path2345" />
                          </g>
                ...
                547 S Mason Road, New town Street 2548 United State
              </h6>
            </div>
          </div>
      ...
      <div class="col-lg-6">
        <div class="row">
          <div class="col-sm-6">
            <div class="fun-facts-two mt-80">
              <h2 data-max="15"><span>M</span></h2>
              <h6>Satisfied Customers</h6>
            </div>
            <div class="fun-facts-two two mt-80">
              <h2 data-max="20"><span>K</span></h2>
              <h6>Balloon Designs in Stock</h6>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="fun-facts-two two ms-0">
              <h2 data-max="10"><span>K</span></h2>
              <h6>Completed Decoration</h6>
            </div>
            <div class="fun-facts-two mt-80 ms-0">
              <h2 data-max="45"><span>+</span></h2>
              <h6>Decorations Themes</h6>
            </div>
          </div>
        </div>
      </div>
...
<section class="gap no-top happy-custom">
  <div class="container">
    <div class="row">
      <div class="col-lg-4">
        <div class="heading two mt-80">
        ...
        <div class="out-of">
          ...
          <h4>4.9 <span>out of 5.0</span></h4>
        </div>
      </div>
      <div class="col-lg-8">
        <div class="review-slider owl-carousel owl-theme">
          <div class="item review-style">
            <img alt="review" class="girl" src="https://placehold.co/320x320">
            <div class="review">
              <div class="star">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
              ...
              <p>“ A huge Thanks Only team to
                select me for review of product.
                Its really mean lots to send me
                products and i like to suggest all
                to buy them. ”</p>
              <h5>Nomina Willimes</h5>
    ...
    <img alt="shaps" class="shaps" src="assets/img/shaps.png">
  </div>
</section>
<?php
get_footer();
