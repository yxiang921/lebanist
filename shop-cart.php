                        ...
                        <tbody>
                            <tr class="product">
                                <td class="product-name">
                                    <img alt="img" src="https://placehold.co/70x70">
                                    <div>
                                        <span>Red Heart Balloon Decoration</span>
                                        <p>Size: 8x</p>
                                        <p>Color: Pink</p>
                                        <p>SKU: 25-0458</p>
                                    </div>
                                ...
                                <td class="product-price">
                                    <span class="woocommerce-Price-amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>18.61</bdi>
                                    </span>          
                                </td>
                                <td class="product-quantity">
                                    <input type="number" class="input-text" value="1" min="1" >
                                </td>
                                <td class="product-subtotal">
                                    <span class="woocommerce-Price-amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>18.61</bdi></span>
                                </td>
              ...
              <div class="col-lg-4">
                <div class="coupon-area">
                            ...
                            <div class="coupon">
                                ...
                                <button type="submit" class="btn" name="apply_coupon"><span>Apply coupon</span>
                                </button>
                            </div>
                        </div>
