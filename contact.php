    ...
    <div class="row">
      <div class="col-xl-6">
        <div class="heading two">
          <h2>Let's Chat. Tell me about your Occasion.</h2>
          <p>contact us and one of our delightful team will be be happy to help.</p>
        </div>
      ...
      <div class="col-xl-6">
        <div class="contact-style-text">
          <div class="contact-style call-us">
          ...
          <div class="contact-style call-us three">
            <img alt="call" src="assets/img/mail.png">
            <div>
              <span>Email Address</span>
              <a href="mailto:name@domain.com">name@domain.com</a>
              <p>Send additional information for decoration theme</p>
            </div>
          </div>
        </div>
      </div>
...
<section class="gap no-top">
  <div class="container">
    <div class="store-locations">
      <div class="store-locations-text">
        ...
        <div class="content-location">
          <div><span>1</span></div>
          <div>
            <p>547 S Mason Road, New town Street 2548 United State</p>
        ...
        <a href="#" class="btn"><span>Get directions</span></a>
      </div>
